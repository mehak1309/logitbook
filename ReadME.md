...
> *Building modern language models from the ground up.*

My personal repo for understanding modern LLMs from the inside out, covering architectures, training pipelines, and the techniques underneath, all built from scratch.
...
| | technique | paper |
|:---:|:---|:---|
| [x] | positional encoding | [Vaswani et al. 2017](https://arxiv.org/abs/1706.03762) |
| [x] | byte pair encoding | [Sennrich et al. 2016](https://arxiv.org/abs/1508.07909) |
| [x] | online softmax | [Milakov & Gimelshein 2018](https://arxiv.org/abs/1805.02867) |
| [x] | label smoothing | [Szegedy et al. 2016](https://arxiv.org/abs/1512.00567) |
| [ ] | rotary position embeddings | [Su et al. 2021](https://arxiv.org/abs/2104.09864) |
